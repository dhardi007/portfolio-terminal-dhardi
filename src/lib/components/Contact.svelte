    ...
    <div class="window__content">
      ...
      <div class="terminal-line__output">
        <a href="https://github.com/dizzi1222" target="_blank">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="#888" style="vertical-align:middle;margin-right:4px">
      ...
      <div class="terminal-line__output">
        <a href="https://www.instagram.com/diego.sam042/" target="_blank">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="#888" style="vertical-align:middle;margin-right:4px">
            <path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6m9.65 1.5a1.25 1.25 0 0 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 7a5 5 0 0 1 0 10 5 5 0 0 1 0-10m0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/>
          </svg> @diego.sam042
        </a>
      </div>
      ...
      <div class="terminal-line__output">
        <a href="#" onclick={openCV}>⬇ Ver CV</a>
...
{#if cvModalOpen}
  <div class="modal-overlay active">
    <div class="modal-backdrop" onclick={closeCV}></div>
    <div class="window modal-window" style="max-width:700px">
      ...
      <div class="window__content">
        <div style="background:var(--bg-tertiary);padding:var(--gap-xl);text-align:center;border:1px solid var(--text-dim);margin-bottom:var(--gap-md)">
          <span style="font-size:3rem;color:var(--accent-tertiary)">📄</span>
        </div>
